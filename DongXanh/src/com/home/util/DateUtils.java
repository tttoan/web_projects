...
public class DateUtils {
	...
	public static final String[] FULLTIME = new String[]{"dd-MM-yyyy HH:mm", "dd-MM-yyyy HH:mm:ss", "yyyy-MM-dd HH:mm:ss.SSS", 
	...
	public static final String[] FULLTIME_REPORT = new String[]{"dd-MM-yyyy HH:mm:ss.SSS", 
		"dd-MM-yyyy HH:mm:ss.S", "dd-MM-yyyy HH:mm:ss.SS"};
	...
	public static long getExactlyTime(String time) throws ParseException{
		return time != null ? 
				org.apache.commons.lang.time.DateUtils.parseDate(time, FULLTIME).getTime() : null;
	}
	...
	public static void main(String[] args) throws ParseException {
		try {
			...
			/*System.out.println(DateUtils.getDateFromString("1-1-2010 23:59:59", DateUtils.FULLTIME_TO_VIEW).getTime());
			System.out.println(DateUtils.getDateFromString("1-01-2010", DateUtils.DD_MM_YYYY).getTime());
			System.out.println(DateUtils.formmatStringDate(new Date(1268240400000l),DateUtils.FULLTIME_TO_VIEW));
			System.out.println(DateUtils.formmatStringDate(new Date(1262019600000l),DateUtils.FULLTIME_TO_VIEW));
			System.out.println(DateUtils.formmatStringDate(new Date(1260575832704l),DateUtils.DD_MM_YYYY));

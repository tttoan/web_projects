					...
					<div class="x_content">
						...
						<sx:tabbedpanel id="tabContainer" selectedTab="%{chooseTab}">
											...
											<table style="width: 100%">
												<tr>
													<td><a href="#openImportStatisticLevel1"
														class="btn btn-primary"><b>Import Bảng Kê</b></a> <a
														href="#openImportBalanceLevel1" class="btn btn-success"><b>Import
																Số Dư Đầu Kỳ</b></a></td>
												</tr>
											</table>
										</div>
							...
							<sx:div label="Bảng kê Cấp II" id="levelTwo">
								<div class="x_panel">
									<div class="x_content">
										<sx:tabbedpanel id="tabContainer2"
											selectedTab="%{chooseSubTab}">
											<sx:div label="Import" id="quickInvoiceLevel2">
												<div class="x_panel">
													<div class="x_content">
														<div class="item form-group">
															<table style="width: 100%">
																<tr>
																	<td><a href="#openImportStatisticLevel2"
																		class="btn btn-primary"><b>Import Bảng Kê</b></a></td>
																</tr>
															</table>
														</div>
													</div>
											...
											<sx:div label="Export" id="exportInvoiceLevel2">
												<div class="col-md-12 col-sm-12 col-xs-12">
													<div class="x_panel">
														<div class="x_content">
																...
																<div class="form-group">
																	<div class="col-md-6 col-md-offset-3">
																		...
																		<button id="send" type="submit"
																			class="btn btn-primary">Kết xuất bảng kê Cấp
																			II</button>
																	</div>
																</div>
															</s:form>

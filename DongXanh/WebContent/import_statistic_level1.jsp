...
<div id="openImportStatisticLevel1" class="modalWindow">
	<div>
		<div class="modalHeader">
			<h2>Cấu Hình Import Bảng Kê Cấp I</h2>
		...
		<div class="modalContent">
			<s:form action="import_statistic" method="post"
				...
				<table id="tableImportStatisticLevel1"
					...
					<tbody>
						...
						<s:iterator value="listDefineColStatisticLevel1" status="rowStatus">
							<tr class="even pointer">
...
<script>
	$(document).ready(function() {
		$('#tableImportStatisticLevel1').DataTable({
			scrollY : 250,
			paging : false
		});
	});

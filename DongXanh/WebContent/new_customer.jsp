				...
				<div class="x_panel">
					<div class="x_content">
						<s:form action="add_invoice" theme="bootstrap"
							...
							<div class="item form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12" >Cây trồng trong khu vực (chọn cây trồng chính):
								</label>
							</div>
							
							<div class="item form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">Lúa:
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<s:textfield id="product6Hot" name="product6Hot" cssClass="form-control col-md-7 col-xs-12" />
									<s:textfield id="product6Hot" name="product6Hot" cssClass="form-control col-md-7 col-xs-12" />

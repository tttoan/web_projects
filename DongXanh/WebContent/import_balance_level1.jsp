...
<div id="openImportBalanceLevel1" class="modalWindow">
	<div>
		<div class="modalHeader">
			<h2>Cấu Hình Import Số Dư Đầu Kỳ Cấp I</h2>
		...
		<div class="modalContent">
			<s:form action="import_statistic" method="post"
				...
				<table id="tableImportBalanceLevel1"
					...
					<tbody>
						...
						<s:iterator value="listDefineColStatisticBalance" status="rowStatus">
							<tr class="even pointer">
...
<script>
	$(document).ready(function() {
		$('#tableImportBalanceLevel1').DataTable({
			scrollY : 250,
			paging : false
		});
	});
